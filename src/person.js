class Person {
    ...
    hello() { //need to create a way to write the code so that it can take in as many interest as the user has
        return `Hello, my name is ${this.name} and my gender is ${this.gender}, I am ${this.age} years old. My interests are ${this.interests[0]}, ${this.interests[1]} and ${this.interests[2]}.`;
